...
<script>function deleteProduct(productId) {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status) {
                    ...
                    // Optionally, remove the product from the page or reload the page
                    $('#product-' + productId).remove(); // Assuming you have an element with the product ID
                } else {
                    alert('Product deletion occurred');
                }
            },
